...
m.SQL("INSERT INTO empresa.bodegas (nombre, direccion) VALUES ('Bodega Principal Norte', 'Zona Industrial')")
}
// Reverse the migrations
func (m *Bodegas_20260525_133412) Down() {
	m.SQL("DELETE FROM empresa.bodegas WHERE nombre = 'Bodega Principal Norte'")
