...
type UnidadesMedida struct {
	Id                 int       `orm:"column(id_unidad_medida);pk"`
...
// AddUnidadesMedida insert a new UnidadesMedida into database and returns
...
// GetUnidadesMedidaById retrieves UnidadesMedida by Id. Returns error if
// Id doesn't exist
...
// GetAllUnidadesMedida retrieves all UnidadesMedida matches certain condition. Returns empty list if
// no records exist
...
// UpdateUnidadesMedida updates UnidadesMedida by Id and returns error if
...
// DeleteUnidadesMedida deletes UnidadesMedida by Id and returns error if
