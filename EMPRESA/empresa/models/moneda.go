...
type Moneda struct {
	Id                 int       `orm:"column(id_moneda);pk"`
...
// AddMoneda insert a new Moneda into database and returns
...
// GetMonedaById retrieves Moneda by Id. Returns error if
// Id doesn't exist
...
// GetAllMoneda retrieves all Moneda matches certain condition. Returns empty list if
// no records exist
...
// UpdateMoneda updates Moneda by Id and returns error if
...
// DeleteMoneda deletes Moneda by Id and returns error if
