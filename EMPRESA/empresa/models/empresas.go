...
type Empresas struct {
	Id                 int       `orm:"column(id_empresa);pk"`
...
// AddEmpresas insert a new Empresas into database and returns
...
// GetEmpresasById retrieves Empresas by Id. Returns error if
// Id doesn't exist
...
// GetAllEmpresas retrieves all Empresas matches certain condition. Returns empty list if
// no records exist
...
// UpdateEmpresas updates Empresas by Id and returns error if
...
// DeleteEmpresas deletes Empresas by Id and returns error if
